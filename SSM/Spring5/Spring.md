...
2.假设我们要使用有参构造创建对象。（<constructor-arg />）
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean id="user2" class="nuc.ss.pojo.User" c:age="18" c:name="狂神2"/>
</beans>
```
...
3. 在spring的文件中注册 , 并实现aop切入实现 , 注意导入约束 .
   ...
   <beans xmlns="http://www.springframework.org/schema/beans"
       ...
       <!--注册bean-->
       <bean id="service" class="com.yang.service.UserServiceImpl"/>
