...
<template>
  <div class="">
          ...
          <div class="headBox">
            <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect"
             ...
             <!--搜索框-->
              ...
              <el-input style="width:30%;margin-top: 3px;opacity: 0.5" placeholder="请输入内容"></el-input>
              <el-button type="primary" plainslot="append">搜索</el-button>
    ...
    <div class="headImgBox"
         :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/headbg01.jpg)'}">
      <div class="scene">
      ...
      <div class="h-information">
        ...
        <h2 class="h-description">
          ...
          {{ this.$store.state.themeObj.autograph ? this.$store.state.themeObj.autograph : "心有猛虎，细嗅蔷薇" }}
...
export default {
  data() { //选项 / 数据
    return {
      ...
      // path:'',//当前打开页面的路径
      input: '', //input输入内容
      headBg: 'url(static/img/background.jpg)', //头部背景图
      headTou: '', //头像
      projectList: '' //项目列表
    }
  },
  ...
  mounted() { //页面元素加载完成
    ...
    var timer = setTimeout(function () {
      Typeit(that.$store.state.themeObj.user_start, "#luke"); //打字机效果  文字设置：blogVue/yang-blog-vue/src/utils/plug.js
      clearTimeout(timer);
    }, 500);
  }
}
