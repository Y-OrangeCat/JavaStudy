...
public class AddCommentDto {
    ...
    public boolean equals(final Object o) {
        ...
        final AddCommentDto other = (AddCommentDto) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof AddCommentDto;
    }
    ...
    public String toString() {
        return "AddCommentDto(id=" + this.getId() + ", type=" + this.getType() + ", articleId=" + this.getArticleId() + ", rootId=" + this.getRootId() + ", content=" + this.getContent() + ", toCommentUserId=" + this.getToCommentUserId() + ", toCommentId=" + this.getToCommentId() + ", createBy=" + this.getCreateBy() + ", createTime=" + this.getCreateTime() + ", updateBy=" + this.getUpdateBy() + ", updateTime=" + this.getUpdateTime() + ", delFlag=" + this.getDelFlag() + ")";
    }
}
