...
public class AddArticleDto {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof AddArticleDto)) return false;
        final AddArticleDto other = (AddArticleDto) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof AddArticleDto;
    }
    ...
    public String toString() {
        return "AddArticleDto(id=" + this.getId() + ", title=" + this.getTitle() + ", content=" + this.getContent() + ", summary=" + this.getSummary() + ", categoryId=" + this.getCategoryId() + ", thumbnail=" + this.getThumbnail() + ", isTop=" + this.getIsTop() + ", status=" + this.getStatus() + ", viewCount=" + this.getViewCount() + ", isComment=" + this.getIsComment() + ", tags=" + this.getTags() + ")";
    }
}
