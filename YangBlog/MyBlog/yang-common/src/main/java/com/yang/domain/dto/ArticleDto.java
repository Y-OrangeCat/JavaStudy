...
public class ArticleDto {
    ...
    public String toString() {
        return "ArticleDto(id=" + this.getId() + ", title=" + this.getTitle() + ", content=" + this.getContent() + ", summary=" + this.getSummary() + ", categoryId=" + this.getCategoryId() + ", thumbnail=" + this.getThumbnail() + ", isTop=" + this.getIsTop() + ", status=" + this.getStatus() + ", viewCount=" + this.getViewCount() + ", isComment=" + this.getIsComment() + ", tags=" + this.getTags() + ")";
    }
}
